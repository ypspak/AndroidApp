...
public class QuestionListAdapter extends FirebaseListAdapter<Question> {
    ...
    protected void populateView(View view, Question question) {
        ...
        if (activity instanceof MainActivity) {
            ...
            ((TextView) view.findViewById(R.id.parent_question_desc)).setText(Html.fromHtml("" + question.getDesc()));
        }
        else if (activity instanceof SearchResultActivity) {
            dbUtil = ((SearchResultActivity) activity).getDbutil();
            if (question.getDesc().equals(""))
                ((TextView) view.findViewById(R.id.parent_question_desc)).setText(Html.fromHtml("Empty message."));
            else
                ((TextView) view.findViewById(R.id.parent_question_desc)).setText(Html.fromHtml("" + replaceFilterStr(question.getDesc(), filterStr)));
